      ...
      <div className=" mx-10 my-5">
        ...
        {section === 'personal' && (
            ...
            <div className=' flex gap-32 items-center'>
              ...
              <input
                ...
                //   onChange={}
                  placeholder='Name' 
                  type="text" className="mt-1 block w-1/2 p-1 bg-[#34353A] border border-slate-500 text-sm shadow-sm placeholder-slate-400 focus:outline-none focus:border-white text-white text-[17px] placeholder:text-[17px]"/>
            </div>
            <div className=' flex gap-32 items-center'>
            ...
            <div className=' flex gap-[110px]'>
              ...
              <textarea
                ...
                //    value={message}
                   name=""
                   placeholder='Address'
                   className="mt-1 block w-1/2 p-4 bg-[#34353A] border border-slate-500 text-sm shadow-sm placeholder-slate-400 focus:outline-none focus:border-white text-white text-[17px] placeholder:text-[17px]" id="" cols="10" rows="4"></textarea>
              </div>
        ...
        {section === 'login' && (
            ...
            <div className=' flex gap-14 items-center'>
              <span className=' text-[17px] text-stone-300 font-bold'>Phone Number</span>
              <input
                  required
                //   value={}
                //   onChange={}
            ...
            <div className=' flex gap-32 items-center'>
              <span className=' text-[17px] text-stone-300 font-bold'>Email</span>
              <input
                  required
                //   value={}
                //   onChange={}
        ...
        {section === 'password' && (
              ...
              <div className=" text-white flex flex-col gap-10 p-5">
              <div className=' flex gap-14 items-center'>
                <span className=' text-[17px] text-stone-300 font-bold'>Current Password</span>
                <input
                    required
                  //   value={}
                  //   onChange={}
              ...
              <div className=' flex gap-20 items-center'>
                <span className=' text-[17px] text-stone-300 font-bold'>New Password</span>
                <input
                    required
                  //   value={}
                  //   onChange={}
              ...
              <div className=' flex gap-12 items-center'>
                <span className=' text-[17px] text-stone-300 font-bold'>Confirm Password</span>
                <input
                    required
                  //   value={}
                  //   onChange={}
